 ...
 */
export class Project2imgHolder extends DDDSuper(I18NMixin(LitElement)) {

  static get tag() {
    return "project-2-imgHolder";
  }
...
globalThis.customElements.define(Project2imgHolder.tag, Project2imgHolder);